 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Bmatovu\LaravelXml\LaravelXmlServiceProvider::boot()
         * @static 
         */ 
        public static function isXml()
        {
                        return \Illuminate\Http\Request::isXml();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sentXml()
        {
                        return \Illuminate\Http\Request::sentXml();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::xml();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function wantsXml()
        {
                        return \Illuminate\Http\Request::wantsXml();
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function xml($data, $status = 200, $headers = [], $options = [])
        {
                        return \Illuminate\Routing\ResponseFactory::xml($data, $status, $headers, $options);
        }
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function encode($arr, $rootElementName = 'document', $replaceSpacesByUnderScoresInKeyNames = true, $xmlEncoding = 'UTF-8', $xmlVersion = '1.0')
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->encode($arr, $rootElementName, $replaceSpacesByUnderScoresInKeyNames, $xmlEncoding, $xmlVersion);
        }
                    /**
         ...
         * @static 
         */ 
        public static function decode($data, $class_name = 'SimpleXMLElement', $options = 0, $ns = '', $is_prefix = false)
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->decode($data, $class_name, $options, $ns, $is_prefix);
        }
                    /**
         ...
         * @static 
         */ 
        public static function is_valid($xmlStr, $ignoreHtml = true)
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->is_valid($xmlStr, $ignoreHtml);
        }
                    /**
         * Validate XML string.
         *
         ...
         * @static 
         */ 
        public static function validate($xmlStr, $xsdFilePath, $flags = 0, $checkXml = false)
        {
                        /** @var \Bmatovu\LaravelXml\Support\Facades\LaravelXml $instance */
                        return $instance->validate($xmlStr, $xsdFilePath, $flags, $checkXml);
        }
...
namespace  { 
            ...
            class Xml extends \Bmatovu\LaravelXml\LaravelXml {}
