                ...
                @foreach($orders as $order)
                    <tr class="{{$order->deleted_at != null ?'bg-red':''}}">
                        ...
                        <td  class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="{{route('cashier.order.show',$order->id)}}">
                        ...
                        <td>
                            @if($order->store?->counteragent_id)
                                <a href="{{route('cashier.show',$order->store->counteragent_id)}}">{{$order->store->counteragent->name}}</a>
                            @endif
                        </td>
                        <td>
                            @if($order->store?->counteragent_id)
