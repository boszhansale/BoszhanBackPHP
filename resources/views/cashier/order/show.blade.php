...
@section('content')
    <div class="row">
        <div class="col">
            <a class="btn btn-info btn-sm" href="{{route('cashier.order.export-excel',$order->id)}}">
                <i class="fas fa-download">
                </i>
                скачать excel
            </a>
            <a class="btn btn-info btn-sm" href="{{route('cashier.order.waybill',$order->id)}}">
                <i class="fas fa-download">
                </i>
                скачать waybill
            </a>
            <a  class="btn btn-info btn-sm" href="{{route('cashier.order.history',$order->id)}}">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><a href="#">{{$order->salesrep->name}}</a></td>
                        </tr>
                        <tr>
                            <th>Водитель</th>
                            <td><a href="#">{{$order->driver->name}}</a></td>
                        </tr>
                        @if($order->store->counteragent)
                            <tr>
                                <th>Контрагент</th>
                                <td><a href="{{route('cashier.show',$order->store->counteragent_id)}}">{{$order->store->counteragent->name}}</a></td>
                            </tr>
                        @endif
                        <tr>
