...
@section('content')
    <form class="product-edit" action="{{route('admin.counteragent.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div>
                    @foreach($salesreps as $user)
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="salesreps[]" value="{{$user->id}}" id="salesrep_{{$user->id}}">
