                ...
                @foreach($stores as $store)
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="{{route('supervisor.store.show',$store->id)}}">
                            ...
                            {{--                            <a  class="btn btn-danger btn-sm" href="{{route('supervisor.store.delete',$store->id)}}" onclick="return confirm('Удалить?')">--}}
